...
describe('LLM Config', () => {
  ...
  it('round-trips config', () => {
    saveLLMConfig({ apiKey: 'sk-test', model: 'claude-sonnet-4-5-20250514', temperature: 0.5, maxTokens: 2048 })
    const config = getLLMConfig()
  ...
  it('clears config', () => {
    saveLLMConfig({ apiKey: 'sk-test', model: 'claude-sonnet-4-5-20250514', temperature: 0.7, maxTokens: 4096 })
    clearLLMConfig()
